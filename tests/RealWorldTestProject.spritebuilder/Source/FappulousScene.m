...
-(void) readerDidLoadSelf
{
	...
	// some of these terms were derives from wildly publicized trademark conflicts, others were taken from Apple's trademark list:
	// https://www.apple.com/legal/intellectual-property/trademark/appletmlist.html
	_badWords = @[@"Candy", @"Saga", @"Edge", @"Paper", @"Flappy", @"Doodle", @"Aperture", @"iCal", @"Keynote", @"Logic", @"Numbers", @"Pages", @"Sherlock", @"Fifa"];
	
	// the good words list is only needed to display some other words to the user
	_goodWords = @[@"pea", @"penguin", @"brave", @"duck", @"carrot", @"corner", @"sage", @"sawtooth", @"cuboid", @"octopus", @"boring", @"clash", @"illogical", @"ball"];
